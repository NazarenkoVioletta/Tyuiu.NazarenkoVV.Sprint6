...
namespace Tyuiu.NazarenkoVV.Sprint6.Task5.V21.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        {
            string path = @"C:C:\Users\Vivobook\source\repos\Tyuiu.NazarenkoVV.Sprint6\Tyuiu.NazarenkoVV.Sprint6.Task5.V21.Lib\bin\Debug\net8.0\InPutFileTask5V21.txt";
